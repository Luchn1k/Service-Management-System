...
public class Payroll extends javax.swing.JPanel {
    ...
    private void print1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_print1ActionPerformed
        ...
        String total_salary = tsalary.getText();
        int work_full_days1 = Integer.parseInt(w_f_date.getText());
        int work_hulf_days1 = Integer.parseInt(w_h_d.getText());
...
//       salary
        ...
        String last_date = lpay_salary_date.getText();
